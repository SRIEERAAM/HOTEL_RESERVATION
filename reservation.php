            ...
            <div class="col-12 mt-4">
                <div class="card p-3">
					...
					<div class="row	">
						<div class="col-3">
                            <div class="form__div">
								<p><span class="d-block">Total Day(s) </span> <span class="text-black" id="total_day" value=""><?php echo $_POST['total_day']; ?></span></p></div></div>
						<div class="col-3">
                            <div class="form__div">
                                <p><span class="d-block">Total Payment </span> <span class="text-black" id="total_pay">RM <?php echo $_POST['total_pay']; ?></span></p></div></div>
						<div class="col-3">
                            <div class="form__div">
					...
					<br><br><p class="mb-0 fw-bold h4">Personal Information</p><br>
					<div class="row	">
						<div class="col-3">
                            <div class="form__div">
					...
					<p class="mb-0 fw-bold h4">Payment Confirmation</p><br>
                        <div class="row	">
							<div class="col-lg-5 mb-lg-0 mb-3">
								...
								<br>
                                <input type="hidden" name="pay_amt" value="<?php echo $_POST['total_pay']; ?>">
									<span class="d-block">Payment Amount </span> 
									<div id="pay_amt">RM <?php echo $_POST['total_pay']; ?></div>
                            </div>
...
<!-- Reservation Form -->
	<?php else : 
		if (isset($_POST['roomType'])) {
			$defaultRoomType = $_POST['roomType'];
			$defaultRoomPrice = $_POST['roomPrice'];
		} else {
			// Default to "Single Room" if roomType is not set
			$defaultRoomType = "Sigle Room";
			$defaultRoomPrice = "90.00";
		}	
	?>
		<section class="section contact-section" id="next">
		  <div class="container">
	...
	<!-- RF: Room Information -->
			  ...
			  <input type="hidden" name="room_type_hidden" value="<?php echo $defaultRoomType; ?>" id="room_type_hidden">
					...
					<span class="text-black">
						<div class="field-icon-wrap">
							...
							<select name="room_type" id="room_type" class="form-control" onchange="updatePrice()">
								<option value="Single" <?php if ($defaultRoomType == "Single Room") echo "selected"; ?>>Single Room</option>
								<option value="Standard" <?php if ($defaultRoomType == "Standard Room") echo "selected"; ?>>Standard Room</option>
								<option value="Family" <?php if ($defaultRoomType == "Family Room") echo "selected"; ?>>Family Room</option>
								<option value="Presidential" <?php if ($defaultRoomType == "Presidential Suite") echo "selected"; ?>>Presidential Room</option>
							</select>
						</div>
					</span>
				</p>
				<input type="hidden" name="room_price_hidden" value="<?php echo $defaultRoomPrice; ?>" id="room_price_hidden">
                <p><span class="d-block">Prices (RM) / per night:</span> <span class="text-black" id="price"><?php echo $defaultRoomPrice; ?></span></p>
              </div>
            </div>
          </div>		
	...
	<!-- RF: Check In and Check Out Dates -->
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="checkin_date" id="checkin_date" class="form-control" required autocomplete="off" onchange="validateCheckinDate()">
                </div>
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="checkout_date">Date Check Out</label>
                  <input type="text" name="checkout_date" id="checkout_date" class="form-control"required autocomplete="off" onchange="validateCheckoutDate()">
